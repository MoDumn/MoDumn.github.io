...
![1.png](resources/FAB265FC24393676DE9844B67B17CBF5.png =783x368)

在`onCreate()`函数里发现有一个结束主Activity的操作，直接去掉

![2.png](resources/C48A69A1153DBE57AA57FA87F86BD11A.png =884x426)

使用AndroidKiller修改代码

![3.png](resources/6805F978DE86D1F3B27593D85034F6D1.png =1920x1050)
...
![4.png](resources/E6B60BD42528676031F1C17721DFC679.png =1920x1050)
...
![5.png](resources/0F52E3075DB7B4E88722C8D45A5DADF6.png =1226x533)
...
![6.png](resources/23CC6F4BF30255FFE72E6A1267F4345B.png =1484x725)

挂上应用，断下来后，在数据窗口跟随R4就可以看到RegCode

![7.png](resources/7C87838477E43F22EF48C3828D277119.png =1920x1051)
