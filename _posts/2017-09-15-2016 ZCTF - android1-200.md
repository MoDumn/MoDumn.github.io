...
![1.png](resources/7A6AF384C17284B00FDD45822D7F1685.png =967x598)
...
![2.png](resources/3CA10C7F1DA879758189755B0F31E105.png =1020x580)
...
![3.png](resources/A1ECD94681C95DCFCE1604B8D9CE9FEC.png =761x1376)
...
![4.png](resources/49ED1D549D6976A0834978A681FA997E.png =785x424)
...
![5.png](resources/8B4C9D417A41BFF70517F959FEC96FBF.png =937x440)

但是这时函数尾识别出错了，需要修复一下函数

使用右键`Edit Function`，修改函数尾部地址

![6.png](resources/1096F888EA9D157F4BC11E746752CCD2.png =784x378)

修改完

![7.png](resources/DAA75B5662B9B6EB2A13E71C0D47CEF7.png =831x323)
...
![8.png](resources/C1871D187EAD0BDBE99ABB85526CE5E8.png =1079x685)

释放前下断，找到`R0`指向的堆空间，可以看到解密出来的是一个PNG文件

![9.png](resources/306EFBADAF7055391198CB5E5D5625D9.png =1080x610)
...
![10.png](resources/F471736AD5B5BC1A93B3337F73F7AA10.png =581x346)

最后，有个很玄学的问题，为了找到为什么一开始写代码解密会出错的原因，我特意看了一下秘钥

![11.png](resources/CDB1F386FEBEA9A75EF8A4336BCF6BBE.png =1037x669)
