...
![1.png](resources/BCB886053837B79B24414D5BA903FE9A.png =1920x1050)
...
![2.png](resources/11ABC6564768786413B34E4C6A83094A.png =1141x716)
...
![3.png](resources/F03289BB06EFE7C80CDEA1F15DDA38E4.png =663x359)

我们找个正常的so文件的文件头拷贝回去，然后再使用IDA打开，发现可以打开了

![4.png](resources/77E31D24DC3112EDAFD57FA7BD5A328D.png =1920x1051)

我们继续分析，整个程序的结构和第一题是一样的

![5.png](resources/D8AA6E13486FFD5A6EB0D608024AEBB1.png =1920x1050)

新建内存空间

![6.png](resources/A0AF8001ACEDE1E989C48943B79A3E98.png =1009x632)

Base64解码

![7.png](resources/35A24BDE8E99B1D38C7F04FE474EA370.png =1413x749)

但是我们在最后校验的地方发现了不一样的地方，它校验的方式是反过来的

![8.png](resources/01C5B5B15959A43CEA08B30D6C245773.png =1543x839)

突然界面就酷炫了起来

那么就比较简单了，注册码就是用户名倒序的Base64编码再插入`-`

![9.png](resources/289FCBD69F333B604F8A047F73DDF77F.png =1166x871)
